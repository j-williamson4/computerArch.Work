    ...
    case 0x00:
      switch(funct) {
        ...
        case 0x00: D(cout << "sll " << regNames[rd] << ", " << regNames[rs] << ", " << dec << shamt);
                  ...
                  pipeStats.registerDest(destReg);
                  pipeStats.registerSrc(rs);
                   break;
        ...
        case 0x10: D(cout << "mfhi " << regNames[rd]);
                  ...
                  writeDest = true; destReg = rd;
                  pipeStats.registerDest(destReg);
                  pipeStats.registerSrc(REG_HILO);
                   break;
        ...
        // Multiply $rs * $rt
                  ...
                  aluSrc2 = regFile[rt];
                  pipeStats.registerSrc(rs);
                  pipeStats.registerSrc(rt);
                  pipeStats.registerDest(REG_HILO);
    ...
    case 0x1a: D(cout << "trap " << hex << addr);
              ...
              writeDest = false;
               switch(addr & 0xf) {
                 ...
                 case 0x1: cout << " " << (signed)regFile[rs]; pipeStats.registerSrc(rs); break;
                 case 0x5: cout << endl << "? "; cin >> regFile[rt]; pipeStats.registerDest(rt); break;
...
void CPU::printFinalStats() {
  ...
  cout << "Mem ops: " << ( pipeStats.getMemOps() / static_cast<double>(instructions) ) * 100 
       << "% of instructions" << endl;
  cout << "Branches: " << ( pipeStats.getBranches() / static_cast<double>(instructions) ) * 100 
       << "% of instructions" << endl;
  cout << "  % Taken: " << ( static_cast<double>(pipeStats.getTaken()) / pipeStats.getBranches() ) * 100 << endl;
}
